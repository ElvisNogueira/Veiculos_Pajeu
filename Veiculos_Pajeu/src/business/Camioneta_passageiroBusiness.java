 ...
 */
public class Camioneta_passageiroBusiness {
    private static Camioneta_passageiroBusiness instance;
    private Camioneta_passageiroDAO dao;
    
    public static Camioneta_passageiroBusiness getInstance(){
        if (instance == null) {
            instance = new Camioneta_passageiroBusiness();
        }
        return instance;
    }
    
    private Camioneta_passageiroBusiness(){
