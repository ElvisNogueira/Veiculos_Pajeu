 ...
 */
public class Pessoa_JuridicaBusiness {
    private static Pessoa_JuridicaBusiness instance;
    private Pessoa_JuridicaDAO dao;
    
    public static Pessoa_JuridicaBusiness getInstance(){
        if (instance == null) {
            instance = new Pessoa_JuridicaBusiness();
        }
        return instance;
    }
    
    private Pessoa_JuridicaBusiness(){
